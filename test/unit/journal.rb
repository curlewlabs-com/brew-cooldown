...
Dir.mktmpdir("cooldown-journal-") do |directory|
  ...
  journal.with_lock do
    ...
    loaded = BrewCooldown::Prototype::Journal.new(directory)
    ...
    report = BrewCooldown::Prototype::Journal.new(directory).report(observed: {})
    ...
    begin
      BrewCooldown::Prototype::Journal.new(directory).load
